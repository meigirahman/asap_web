...
<?php		
			...
			$query=("SELECT * from tb_detail_pend_masuk where tanggal_input BETWEEN '$firstdate' and '$lastdate'");
...
<link href="../assets/css/table.css" rel="stylesheet">
	...
	<body>
        ...
        <td>
        <h4> Laporan Data Penduduk Masuk <br /> Kelurahan Citangtu <br />Kecamatan Kuningan </h4>
        </td>
        </tr>
        </table>
        <table width="700px">
			...
			<table  align="center" id="tablei">
                                            ...
                                            <th align="center">Jenis kelamin</th> 
                                             ...
                                             <?php
                                        		...
                                        		<td ><?php echo $r['no_surat_masuk']; ?></td>
