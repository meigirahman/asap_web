...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Kartu Tanda Penduduk',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Kartu Tanda Penduduk',0,0,'R');
//pindah baris
$this->Ln(20);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'NIK', 'Nama','Jenis Kelamin', 'RT', 'RW');
// Data loading

$query="SELECT DATE_FORMAT(tb_ktp.tanggal_input, '%d-%m-%Y') as tanggal_input,
         tb_detail_ktp.nik, tb_detail_ktp.nama, tb_detail_ktp.jenis_kelamin,
         tb_detail_ktp.no_rt, tb_detail_ktp.no_rw from tb_ktp,tb_detail_ktp 
       		where tb_detail_ktp.nik=tb_ktp.nik and
...
$pdf->judultabel('Laporan Data Kartu Tanda Penduduk Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapKTP.pdf','D');
?>
