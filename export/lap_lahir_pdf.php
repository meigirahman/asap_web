...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Kaelahiran',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Kelahiran',0,0,'R');
//pindah baris
$this->Ln(20);
...
function FancyTable($header, $data)
{
	...
	$this->SetFont('','B');
	// Header
	$w = array( 10,30, 30,60,30, 10,10,50,50);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'No Surat Kelahiran', 'Nama','Jenis Kelamin', 'RT', 'RW','Ayah','Ibu');
// Data loading

$query="SELECT DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input,no_surat_kelahiran,
                                                    nama,  jenis_kelamin, no_rt,no_rw,nama_ayah,nama_ibu from tb_kelahiran 
...
$pdf->judultabel('Laporan Data Kelahiran Desa Cempaka Kecamatan Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapKelahiran.pdf','D');
?>
