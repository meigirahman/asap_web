...
$qrykoreksi=mysql_query("select nik, kk,DATE_FORMAT(tanggal_input, '%Y-%m-%d') as tanggal_input,no_surat, nama, tempat,
                                     DATE_FORMAT(tanggal_lahir, '%Y-%m-%d') as tanggal_lahir,pekerjaan, agama,jenis_kelamin,alamat,no_rt,no_rw,
                                     oleh from tb_surat_domisili where no_surat='$no_surat' LIMIT 1");
...
<html>
	...
	<body >
		<div class='span1  offset12'>
                                    ...
                                    <tr>
                                    <td colspan="5"><center><b style="font-size: 23px;"><u>SURAT KETERANGAN MENETAP/DOMISILI</u></b></center></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td>- </td><td colspan="4"> <p class="letter5">Nama tersebut diatas memang benar Menetap / Berdomisili di <?php echo $dataku->alamat ?> RT. <?php echo $dataku->no_rt ?> / RW. <?php echo $dataku->no_rw ?> Kecamatan Sekayu Kabupaten Musi Banyuasin.</td></tr>
