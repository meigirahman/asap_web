...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Penduduk Masuk',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Penduduk Masuk',0,0,'R');
//pindah baris
$this->Ln(20);
...
function FancyTable($header, $data)
{
	...
	$this->SetFont('','B');
	// Header
	$w = array( 10,25, 100,50,50,30,10, 10);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'No Surat', 'NIK','Nama','Jenis Kelamin', 'RT', 'RW');
// Data loading

$query="SELECT DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input,
                                                    no_surat_masuk,nik, nama, jenis_kelamin,no_rt, no_rw
                                                    from tb_detail_pend_masuk where tanggal_input BETWEEN '$firstdate' and '$lastdate'";
...
$pdf->judultabel('Laporan Data Penduduk Masuk Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapMsuk.pdf','D');
?>
