...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Register Surat Pengantar/Keterangan',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Register Surat Pengantar/Keterangan',0,0,'R');
//pindah baris
$this->Ln(20);
...
$query="SELECT DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input,
                                                    ...
                                                    no_rt,no_rw from tb_surat where
...
$pdf->judultabel('Laporan Register Surat Pengantar/Keterangan Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapSurat.pdf','D');
?>
