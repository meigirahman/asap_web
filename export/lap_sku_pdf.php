...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Register SKU',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Register SKU',0,0,'R');
//pindah baris
$this->Ln(20);
...
$pdf->judultabel('Laporan Register SKU Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapSKU.pdf','D');
?>
