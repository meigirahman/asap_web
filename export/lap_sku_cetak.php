...
<?php		
   ...
   mysql_select_db("kependudukanok");
			$query=("SELECT DATE_FORMAT(tanggal_input, '%d-%m-%Y') as tanggal_input,
                                                    ...
                                                    no_rt,no_rw from tb_surat_usaha where tanggal_input BETWEEN '$firstdate' and '$lastdate'");
...
<link href="../assets/css/table.css" rel="stylesheet">
	...
	<body>
        ...
        <td>
        <h4> Laporan Register SKU <br /> Kelurahan Citangtu <br />Kecamatan Kuningan  </h4>
        </td>
        </tr>
        </table>
        <table width="700px">
