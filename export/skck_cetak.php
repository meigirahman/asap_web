...
$qrykoreksi=mysql_query("select nik,kk, DATE_FORMAT(tanggal_input, '%Y-%m-%d') as tanggal_input,no_surat, nama, tempat,
                                     ...
                                     oleh from tb_surat_skck where no_surat='$no_surat' LIMIT 1");
...
<html>
	...
	<body >
		<div class='span1  offset12'>
                                    ...
                                    <tr>
                                    <td colspan="5"><center><b style="font-size: 20px;"><u>SURAT PENGANTAR KETERANGAN CATATAN KEPOLISIAN</u></b></center></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td>- </td><td colspan="4"> Dijelaskan nama tersebut diatas bermaksud mendapatkan Surat Keterangan Catatan Kepolisian (SKCK) <b><i><?php echo $dataku->keperluan ?></b></i></td></tr>
                                    <tr><td>- </td><td colspan="4" > Surat keterangan pengantar (SKCK) ini berlaku sampai dengan : <b><?php echo tanggal_indo($dataku->tanggal_akhir) ?></b></td></tr>
                                    <tr><td>2</td><td colspan="4"> Berhubung dengan maksud yang bersangkutan, diminta agar yang berwenang dapat memberikan bantuan fasilitas </td>
									<tr><td>&nbsp;</td><td colspan="4"> seperlunya.</td>
