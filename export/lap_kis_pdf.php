...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Penduduk Per RT/RW',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Penduduk Per RT/RW',0,0,'R');
//pindah baris
$this->Ln(20);
...
function FancyTable($header, $data)
{
	...
	$this->SetFont('','B');
	// Header
	$w = array( 10,30, 60,40,40,40,30,10, 10);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Nomor KIS', 'Nama','Jenis Kelamin','Tempat','Tanggal Lahir', 'Status Nikah','RT', 'RW');
// Data loading
$rt=$_GET['rt'];
$rw=$_GET['rw'];
...
$pdf->judultabel('Laporan Data Penduduk Per RT/RW Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapRT/RW.pdf','D');
?>
