...
header("Content-Disposition: attachment; filename=laporanMasuk$firstdate.-.$lastdate;");
?>
<html>
<head>
<title>Laporan Data Penduduk Masuk Periode s.d</title>
<style type="text/css">
table, td, th
{
...
<body>
<p align="center"><strong>Laporan Data Penduduk Masuk <br>
...
<table width="459" border="1" align="center">
  <tr>
    ...
    <th><div align="center">No Surat Masuk </div></th>
...
echo"<tr>
    ...
    <td><div align=center>$brs[no_surat_masuk]</div></td>
