...
$qrykoreksi=mysql_query("select nik, kk,DATE_FORMAT(tanggal_input, '%Y-%m-%d') as tanggal_input,no_surat, nama, tempat,
                                     DATE_FORMAT(tanggal_lahir, '%Y-%m-%d') as tanggal_lahir,pekerjaan, agama,jenis_kelamin,alamat,no_rt,no_rw,benda,lokasi,
                                     DATE_FORMAT(tanggal_akhir, '%Y-%m-%d') as tanggal_akhir,
									 oleh from tb_surat_hilang where no_surat='$no_surat' LIMIT 1");
...
<html>
	...
	<body >
		<div class='span1  offset12'>
                                    ...
                                    <tr>
                                    <td colspan="5"><center><b style="font-size: 23px;"><u>SURAT KETERANGAN KEHILANGAN</u></b></center></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td>- </td><td colspan="4"> <p class="letter5">Bahwa benar yang bersangkutan telah kehilangan <?php echo $dataku->benda ?>.</td></tr>
                                    <tr><td>- </td><td colspan="4"> <p class="letter5">Hilang di Seputaran wilayah <?php echo $dataku->lokasi ?>.</td></tr>
                                   <tr><td>- </td><td colspan="4"> <p class="letter5">Surat Keterangan Pengantar Kehilangan ini berlaku sampai dengan <?php echo tanggal_indo($dataku->tanggal_akhir) ?>.</td></tr>
                                   
								   
									<tr><td>2</td><td colspan="4"> Berhubung dengan maksud yang bersangkutan, diminta agar yang berwenang dapat memberikan bantuan fasilitas seperlunya. </td>
