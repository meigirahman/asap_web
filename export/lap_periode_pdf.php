...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Penduduk',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Penduduk',0,0,'R');
//pindah baris
$this->Ln(20);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'Nama','Jenis Kelamin','Tempat','Tanggal Lahir', 'Status Nikah','RT', 'RW');
// Data loading
...
$pdf->judultabel('Laporan Data Penduduk Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapPeriode.pdf','D');
?>
