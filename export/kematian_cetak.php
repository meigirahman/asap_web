...
$qrykoreksi=mysql_query("select nama, 	DATE_FORMAT(tanggal_input, '%Y-%m-%d') as tanggal_input,no_surat_kematian, tempat,berdasarkan,pukul,hari_meninggal,tanggal_meninggal,
										DATE_FORMAT(tanggal_lahir, '%Y-%m-%d') as tanggal_lahir,jenis_kelamin,alamat,no_rt,no_rw,umur,sebab,tempat_meninggal,
...
<html>
	...
	<body >
		<div class='span1  offset12'>
                                    ...
                                    <tr>
                                    <td colspan="5"><center><b style="font-size: 23px;"><u>SURAT KETERANGAN KEMATIAN</u></b></center></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <td colspan="5">Berdasarkan Surat Keterangan <b><?php echo $dataku->berdasarkan ?></b></td>
                                    ...
                                    <tr>
                                    <td>&nbsp;</td><td>&nbsp;</td><td>Umur</td><td>:</td><td><?php echo $dataku->umur ?> tahun</td>
                                    </tr>
									...
									<td colspan="5">Telah meninggal dunia pada : </td>
									<tr>
									...
									<tr><td>&nbsp;</td><td>&nbsp;</td><td  colspan="3">&nbsp;</td></tr>
									<td colspan="5">Disebabkan karena <b><?php echo $dataku->sebab ?></b> dan telah meninggal di <b><?php echo $dataku->tempat_meninggal ?></b></td>
									<tr><td>&nbsp;</td><td>&nbsp;</td><td  colspan="3">&nbsp;</td></tr>
									<tr>
