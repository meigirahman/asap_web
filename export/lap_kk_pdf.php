...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Kartu Keluarga',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Kartu Keluarga',0,0,'R');
//pindah baris
$this->Ln(20);
...
function FancyTable($header, $data)
{
	...
	$this->SetFont('','B');
	// Header
	$w = array( 10,30, 60,10,10,60, 40, 40);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'Nama KK', 'RT','RW', 'Anggota', 'Jenis Kelamin', 'Status Hubungan');
// Data loading

$query="SELECT DATE_FORMAT(tb_kk.tanggal_input, '%d-%m-%Y') as tanggal_input,
...
$pdf->judultabel('Laporan Data Kartu Keluarga Desa Cempaka Kecamatan Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapKK.pdf','D');
?>
