...
header("Content-Disposition: attachment; filename=laporanLahir$firstdate.-.$lastdate;");
?>
<html>
<head>
...
<body>
<p align="center"><strong>Laporan Data Kelahiran <br>
...
<table width="459" border="1" align="center">
  <tr>
    ...
    <th><div align="center">No Surat Kelahiran </div></th>
...
echo"<tr>
    ...
    <td><div align=center>$brs[no_surat_kelahiran]</div></td>
    ...
    <td><div align=center>$brs[nama_ayah]</div></td>
    <td><div align=center>$brs[nama_ibu]</div></td>
	</tr>";
  $i++;
   }
