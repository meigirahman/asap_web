...
<link href="../assets/css/table.css" rel="stylesheet">
	...
	<body>
        ...
        <tr>
        <td colspan="3">
        <img src="logo.png" width="50" height="50" align="left"/>
        </td>
        <td>
        <h4> LAPORAN DATA PENDUDUK <br /> Kelurahan Serasan Jaya <br />Kecamatan Sekayu </h4>
        </td>
        </tr>
        </table>
        <table width="700px">
			...
			<table  align="center" id="tablei">
                                            ...
                                            <th align="center">RT/RW</th>
                                             ...
                                             <?php
                                                    ...
                                                    no_rt,no_rw from tb_penduduk where no_rt= '$rt' and no_rw='$rw'");
