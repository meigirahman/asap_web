...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Kematian',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Kematian',0,0,'R');
//pindah baris
$this->Ln(20);
...
function FancyTable($header, $data)
{
	...
	$this->SetFont('','B');
	// Header
	$w = array( 10,25, 50,60,30,30,20,10, 10,20);
	...
	foreach($data as $row)
	{
        ...
        $this->Cell($w[9],6,$row[8],'LR',0,'L',$fill);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'NIK', 'Nama','Jenis Kelamin','Tgl Meninggal','Umur', 'RT', 'RW','Sebab');
// Data loading

$query="SELECT DATE_FORMAT(tb_kematian.tanggal_input, '%d-%m-%Y') as tanggal_input,
