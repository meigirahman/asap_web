...
$qrykoreksi=mysql_query("select nik, no_kk,DATE_FORMAT(tanggal_input, '%Y-%m-%d') as tanggal_input,no_surat, nama, tempat,
                                     DATE_FORMAT(tanggal_lahir, '%Y-%m-%d') as tanggal_lahir,pekerjaan, agama,jenis_kelamin,alamat,no_rt,no_rw,keperluan,
                                     oleh from tb_detail_kematian where no_surat='$no_surat' LIMIT 1");
...
<html>
	...
	<body >
		<div class='span1  offset12'>
                                    ...
                                    <tr>
                                    <td colspan="5"><center><b style="font-size: 25px;"><u>SURAT KETERANGAN TIDAK MAMPU</u></b></center></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td>- </td><td colspan="4"> <p class="letter5">Bahwa memang benar nama diatas dalam keadaan miskin/tidak mampu. Surat Keterangan ini kami berikan untuk melengkapi persyaratan <b><?php echo $dataku->keperluan ?>.</b></td></tr>
