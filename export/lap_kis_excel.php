...
<table width="459" border="1" align="center">
  <tr>
    ...
    <th><div align="center">Nomor KIS</div></th>
  ...
  <?php
   ...
   $view=("SELECT  no_surat_kelahiran, nama, jenis_kelamin,tempat, DATE_FORMAT(tanggal_lahir, '%d-%m-%Y') as tanggal_lahir,status_nikah,no_rt,no_rw from tb_penduduk where (no_rt= '$rt' and no_rw='$rw') and no_surat_kelahiran!='-'");
   $ok=mysql_query($view);
   $i=1;
