...
$this->Cell(15);
//judul
$this->Cell(30,10,'Laporan Data Penduduk Pindah',0,0,'L');
$this->Ln(4);
$this->Cell(15);
...
$this->Ln(4);
$this->Cell(80);
$this->Cell(200,10,'File: Laporan Data Penduduk Pindah',0,0,'R');
//pindah baris
$this->Ln(20);
...
function FancyTable($header, $data)
{
	...
	$this->SetFont('','B');
	// Header
	$w = array( 10,25, 20,50,50,30,10, 10,30);
...
$pdf = new PDF();
// Column headings
$header = array('No', 'Tanggal', 'No SKP', 'NIK','Nama','Jenis Kelamin', 'RT', 'RW','Tanggal Input');
// Data loading

$query="SELECT DATE_FORMAT(tb_pend_pindah.tanggal_input, '%d-%m-%Y') as tanggal_input,
...
$pdf->judultabel('Laporan Data Penduduk Pindah Desa Cempaka Kec. Bumijawa');
$pdf->FancyTable($header,$data);
$pdf->Output('lapPindah.pdf','D');
?>
