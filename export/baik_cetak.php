...
$qrykoreksi=mysql_query("select nik, kk, DATE_FORMAT(tanggal_input, '%Y-%m-%d') as tanggal_input,no_surat, nama, tempat,
                                     DATE_FORMAT(tanggal_lahir, '%Y-%m-%d') as tanggal_lahir,pekerjaan, agama,jenis_kelamin,alamat,no_rt,no_rw,keperluan,
                                     DATE_FORMAT(tanggal_akhir, '%Y-%m-%d') as tanggal_akhir,
                                     oleh from tb_surat_baik where no_surat='$no_surat' LIMIT 1");
...
<html>
	...
	<body >
		<div class='span1  offset12'>
                                    ...
                                    <tr>
                                    <td colspan="5"><center><b style="font-size: 20px;"><u>SURAT KETERANGAN KELAKUKAN BAIK</u></b></center></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td>&nbsp;</td><td  colspan="4">Dengan ini menerangkan,</td></tr>
                                    ...
                                    <tr>
                                    <td>&nbsp;</td><td>h.</td><td>No. KTP</td><td>:</td><td><?php echo $dataku->nik ?></td>
                                    </tr>
                                    ...
                                    <tr><td>- </td><td colspan="4"> <p class="letter5">Bahwa yang bersangkutan memang benar sampai saat ini tidak pernah berurusan Perkara dangen Pihka Kepolisian, Surat Keterangan ini digunakan untuk melengkpai salah satu <b><i><?php echo $dataku->keperluan ?>.</i></b></td></tr>
                                    
									<tr><td>- </td><td colspan="4" > Surat keterangan ini berlaku sampai dengan : <b><?php echo tanggal_indo($dataku->tanggal_akhir) ?></b></td></tr>
                                   
								   <tr><td>2</td><td colspan="4"> <p class="letter5">Berhubung dengan maksud yang bersangkutan, diminta agar yang berwenang dapat memberikan bantuan fasilitas </td><td>&nbsp;</td><td>&nbsp;</td>
																				
									<tr>
                                    <td colspan="5">Demikian surat keterangan ini dibuat untuk dipergunakan sebagaimana mestinya.</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
                                    </tr>
