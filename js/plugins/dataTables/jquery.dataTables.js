...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default (filter dari _MAX_ total data)
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoFiltered": " - filter dari _MAX_ records"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoPostFix": "Semua record yang ditampilkan diperoleh dari informasi yang sebenarnya."
			 *        }
			 *      } );
			 *    } );
			 */
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Menampilkan x dari y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
