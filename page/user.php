                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
													  ...
													  <a  href='home.php?p=rekening_input' class='btn btn-primary btn-sm'>
						<span class='glyphicon glyphicon-edit'></span> Tambahkan Data
								...
								<form name="FLaporan" method="post" action="hapus_banyak_skck.php" onsubmit="return confirm('Hapus data terpilih?')" >
                                    ...
                                    <?
                                    $myquery="select * from tb_rek where bid='$_SESSION[bidang]' order by id_keg,id_rek asc";
                                    $no=1;
                                   ...
                                   <td align="center"><?php echo $no;?></td>
                                    <td align="center"><?php echo $dataku->id_keg?></td>
                                    <td align="center"><?php echo $dataku->id_rek?></td>
