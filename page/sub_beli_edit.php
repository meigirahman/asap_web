...
<div style='margin-left: 50px' class='col-lg-3'>	
 <div class="panel panel-info">
  ...
  <form role="form" name="tes" method="post" action="home.php?p=sub_beli_update">
...
$myquery="select * from tb_beli_rinci where kd_beli_rinci='$_GET[kd_beli_rinci]' limit 1";
...
?>	
									...
									<div class="form-group"> 				
										...
										<input class="form-control" type="date"  name="expired" id="expired" value="<?php echo $dataku->expired?>"  />
									</div>
