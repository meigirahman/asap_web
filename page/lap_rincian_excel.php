...
<center>Periode <?php echo date("d F Y", strtotime('2021-01-01')) ?> s.d. <?php echo date("d F Y", strtotime($_POST['tgl'])); ?></center></td></tr>	</b> 
  ...
  <?
                                   ...
                                   $opd=mysql_fetch_object($oo);?>                                                              
		  ...
		  </br> <font style="font-size: 14pt; align:left;"><b>Perangkat Daerah : <?php echo $opd->nama?></br></br> 
                                    ...
                                    <th align="center"><center>Masuk</th>
                                    <th align="center"><center>Keluar</th>
                                    <th align="center"><center>Sisa</th>
                                    <th align="center"><center>Saldo Awal</th>
									  <th align="center"><center>Pembelian</th>
                                    <th align="center"><center>Pemakaian</th>
									<th align="center"><center>Persediaan</th>
									</tr>
									...
									<?
									 $awal2="select sum(jumlah) as jumlah from tb_saldo_rinci where kd_brg='$dataku->kd_brg' and kd_opd='$_SESSION[kd_opd]' group by kd_brg ";
								   ...
								   {echo $sawal=0;} ?>
									 ...
									 $a="select * from tb_stok where kd_brg='$dataku->kd_brg' and kd_opd='$_SESSION[kd_opd]' order by tgl desc limit 1 ";
                                    
                                    $aa=mysql_query($a) or die (mysql_error());
                                   $harga=mysql_fetch_object($aa);
								   ?>
										 <td style="text-align: right;" ><?
									 $mmm="select sum(jumlah) as jlh from tb_stok where kd_brg='$dataku->kd_brg' and opsi='masuk' and kd_opd='$_SESSION[kd_opd]' order by harga_satuan desc limit 1 ";
									 $kkk="select sum(positif) as jlh from tb_stok where kd_brg='$dataku->kd_brg' and opsi='keluar' and kd_opd='$_SESSION[kd_opd]' order by harga_satuan desc limit 1 ";
