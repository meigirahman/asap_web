...
<div class="panel-heading">
	...
	<?
	$sql_data   = "select * from tb_beli_rinci where kd_opd='$_GET[kd_opd]' and kd_beli='$_GET[kd_beli]' ";
...
<?
	...
	echo "
		  ...
		  echo "Rp " . number_format($jumlah,2,',','.')."</td>
				  ...
				  <td>
					<center>
					  <a href='?p=sub_rinci_belanja_hapus&kd_opd=$data[kd_opd]&kd_beli_rinci=$data[kd_beli_rinci]' class='btn btn-danger btn-sm'>
						Hapus 
					  </a>
...
<div style='margin-left: 50px' class='col-lg-3'>	
 <div class="panel panel-info">
  ...
  <form role="form" name="tes" method="post" action="home.php?p=beli_simpan">
