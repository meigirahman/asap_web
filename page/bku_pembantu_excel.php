...
header("Content-Disposition: attachment; filename=bku_pembantu.xls");
?>
...
<body>
	...
	<tr><td ALIGN=CENTER  COLSPAN=7><font style="font-size: 14pt; font-weight: bold;">BUKU KAS PEMBANTU</td></tr>
	...
	<tr><td colspan=4>SKPD</td><td colspan=3>:  BADAN PENGELOLA KEUANGAN DAN ASET DAERAH</td></tr>
	   <?
		   $kpa=mysql_fetch_object(mysql_query("select * from tb_user WHERE jabatan='Kuasa Pengguna Anggaran' and bid='$_GET[bidang]'"));
		   				$keg=mysql_fetch_object(mysql_query("select * from ref_keg WHERE kd_keg='$_GET[kd_keg]'"));
...
<tr><td colspan=4>Kode Kegiatan</td><td colspan=3>:  4.04 . 4.04.01.<?php echo $_GET['kd_keg']; ?></td></tr>			
									<tr><td colspan=4>Nama Kegiatan</td><td colspan=3>: <? echo $keg->nm_keg;?></td></tr>					
                    ...
                    <div class="panel panel-success">
                        ...
                        <!-- /.panel-heading -->
                                   ...
                                   <td align="center"   ><?php echo $dataku->id_data;?></td>
                                    ...
                                    $jlh="select A.d,B.k from (select sum(jlh) as d from tb_data where periode='$_GET[bln]' and dk='d' and kd_keg='$_GET[kd_keg]') A, (select sum(jlh) as k from tb_data where periode='$_GET[bln]' and dk='k' and kd_keg='$_GET[kd_keg]') B";
