...
<div style='margin-left: 50px' class='col-lg-3'>	
 <div class="panel panel-info">
  ...
  <form role="form" name="tes" method="post" action="home.php?p=sub_saldo_update">
...
$myquery="select * from tb_saldo_rinci where kd_saldo_rinci='$_GET[kd_saldo_rinci]' limit 1";
