...
header("Content-Disposition: attachment; filename=bap.xls");
?>
                    ...
                    <div >
                        ...
                        <div>
								...
								<tr><td>&nbsp;</td></tr>
									...
									$myquery="select *,sum(jumlah) as jumlah from tb_stok where rek4='$xxx->rek4' and kd_opd='$_SESSION[kd_opd]' and tgl between '2021-01-01' and '$_POST[tgl]'  ";
