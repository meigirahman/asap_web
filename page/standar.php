                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
													  ...
													  <a  href='home.php?p=standar_input' class='btn btn-primary btn-sm'>
						<span class='glyphicon glyphicon-edit'></span> Tambahkan Data
								...
								<form name="FLaporan" method="post" action="hapus_banyak_skck.php" onsubmit="return confirm('Hapus data terpilih?')" >
                                   ...
                                   <td align="center"><?php echo $no;?></td>
                                    ...
                                    <td ><center><?php echo $dataku->satuan?></td>
                                
 
		  <td style="text-align:right"><? echo number_format($dataku->harga,2,',','.')."</td>"?>
 
 
									<td align="center">
                                    
									 <a href="home.php?p=standar_hapus&id=<?php echo $dataku->id?>" title="Hapus" style="color: #1484CE;" onclick="return confirm('Hapus data terpilih?')"><i class="fa fa-trash-o"></i></a>
