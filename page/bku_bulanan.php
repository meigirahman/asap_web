		...
		<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
						...
						<form action="">
                                        <a href='page/bku_bulanan_excel.php?bln=<?PHP ECHO $_POST['bln']?>&bidang=<?PHP ECHO $_SESSION['bidang']?>'
                                    	target='_blank'
...
BULAN <?php echo strtoupper(bulan($_POST['bln'])); ?> 2019								<br><br>
								...
								<form name="FLaporan" method="post" action="hapus_banyak_skck.php" onsubmit="return confirm('Hapus data terpilih?')" >
                                    ...
                                    <?
                                    $myquery="select *, DATE_FORMAT(tgl, '%d-%m-%Y') as tgl from tb_data where periode='$_POST[bln]'";
                                    $no=1;
