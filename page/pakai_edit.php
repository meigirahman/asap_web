...
$myquery="select * from tb_pakai where kd_pakai='$_GET[kd_pakai]' limit 1 ";
                ...
                <div class="col-lg-3">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
							...
							<div class="col-lg-12">
                              <form role="form" name="tes" method="post" action="home.php?p=pakai_update">
							 ...
							 <input class="form-control" type="hidden" required= "" value="<?php echo $dataku->kd_pakai?>" name="kd_pakai" id="kd_pakai"  />
